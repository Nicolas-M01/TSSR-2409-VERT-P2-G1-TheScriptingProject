    		...
    		do
						case $i in
							...
							1 )
								...
								echo -e "${BLUE}Nous allons créer un compte utilisateur${NC}"
							...
							2 )
								...
								read -p "$(echo -e '\033[34mVous souhaitez changer le mot de passe de quel compte utilisateur ? \033[0m')" UserAccountName
								...
								then
									...
									echo -e "${RED}L'utilisateur n'existe pas. Le programme va fermer${NC}"
									exit 1
									fi
							...
							3 )
								...
								read -p "$(echo -e '\033[34mQuel compte souhaitez vous supprimer ? \033[0m')" UserAccountName
							...
							14)
                                ...
                                echo
								echo -n "$(echo -e '\033[34mPour quel fichier voudriez vous connaître les droits ? \033[0m')"
								read file
								echo -n "$(echo -e '\033[34mIndiquez le chemin du fichier que vous recherchez :\033[0m')"
								read path
				...
				do
					case $j in
							...
							10)
								...
								echo -n "$(echo -e '\033[34mSur quel dossier souhaitez-vous des indications ?\033[0m')" 
								read directory

								echo -n "$(echo -e '\033[34mVeuillez renseigner un chemin :\033[0m')" 
								read path
