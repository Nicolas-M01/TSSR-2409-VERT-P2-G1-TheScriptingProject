...
case $choix in
	...
	2)
		...
		echo "[4] Gestion Pare-feu"
		echo "[5] Gestion logiciel"
		echo
		echo "PARTIE INFORMATION"
		echo -e "[6] Version de l'OS"
		echo -e "[7] Nombre de disques"
		echo -e "[8] Partition par disque"
		echo -e "[9] Espace disque restant"
		echo -e "[10] Nom et espace disque d'un dossier"
		echo -e "[11] Liste des lecteurs montés"
		echo -e "[12] Liste des applications/paquets installés"
		echo -e "[13] Liste des services en cours d'execution"
		echo -e "[14] Liste des utilisateurs locaux"
		echo -e "[15] Mémoire RAM totale"
		echo -e "[16] Utilisation de la RAM"
		read choix
